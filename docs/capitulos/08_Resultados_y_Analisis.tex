...
Se puede apreciar que el algoritmo de búsqueda local (LR) mejora claramente la mediana del \textit{accuracy} respecto al enfoque aleatorio (RS).
...
Tal como se observa en la Figura~\ref{fig:lr-vs-gen-v1}, el algoritmo genético (GEN) consigue una \textbf{mediana de \textit{accuracy}} más alta que la búsqueda local (LR),
...
La principal diferencia se observa en la robustez de los resultados: el AM presenta una distribución más estable,
...
\begin{table}[htp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{P{2cm} P{2cm} P{2.5cm} P{2.5cm} P{2.5cm} P{2.5cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2.5cm} P{2.5cm}}
            \toprule
            \textbf{Algoritmo}    & \textbf{Duración Total} & \textbf{Duración por Eva.} & \textbf{Accuracy (Avg)} & \textbf{Precision (Avg)} &
            ...
            \midrule
            AM                    & 00:27:39                & 00:00:17                   & 83,66\%                 & 84,24\%                  & 83,66\%                & 83,09\% & 100 & 35,64\% & 30,87\% & 33,49\% \\
            PR                    & 00:29:02                & 00:00:17                   & 81,93\%                 & 83,07\%                  & 81,93\%                & 81,19\% & 100 & 34,52\% & 32,14\% & 33,33\% \\
            \midrule
            \multicolumn{11}{l}{\textbf{25\%}}                                                                                                                                                                       \\
            \midrule
            AM                    & 00:57:29                & 00:00:34                   & 82,42\%                 & 83,68\%                  & 82,42\%                & 81,78\% & 100 & 33,33\% & 32,54\% & 34,13\% \\
...
Para evaluar el impacto de esta modificación, se generan versiones libres tanto para el algoritmo de búsqueda local (LR)
...
\begin{table}[htp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{P{2.2cm} P{2.2cm} P{2.2cm} P{2.2cm} P{2.2cm} P{2.2cm} P{2cm} P{2.5cm} P{2.5cm}}
            \toprule
            \textbf{Algoritmo}    & \textbf{Duración Total} & \textbf{Duración por Eva.} & \textbf{Porc.
            ...
            \midrule
            AM-F                  & 00:34:33                & 00:00:21                   & 14,94\%       & 82,96\% & 84,07\% & 82,96\% & 82,12\% & 100 \\
            MEM                   & 00:27:43                & 00:00:17                   & 10,00\%       & 82,85\% & 84,44\% & 82,85\% & 81,91\% & 100 \\
            MEM-F                 & 00:32:39                & 00:00:20                   & 9,62\%        & 83,28\% & 84,70\% & 83,28\% & 82,46\% & 100 \\
            \midrule
            \multicolumn{9}{l}{\textbf{25\%}}                                                                                                          \\
            \midrule
            AM-F                  & 01:07:13                & 00:00:40                   & 26,68\%       & 81,77\% & 82,66\% & 81,77\% & 81,18\% & 100 \\
            MEM                   & 00:57:12                & 00:00:34                   & 25,00\%       & 81,99\% & 83,11\% & 81,99\% & 81,21\% & 100 \\
            MEM-F                 & 01:08:54                & 00:00:41                   & 27,18\%       & 82,80\% & 83,77\% & 82,80\% & 82,17\% & 100 \\
            \midrule
            \multicolumn{9}{l}{\textbf{50\%}}                                                                                                          \\
            \midrule
            AM-F                  & 01:51:24                & 00:01:07                   & 46,36\%       & 83,60\% & 85,22\% & 83,60\% & 83,03\% & 100 \\
...
Además, el porcentaje final alcanzado por MEM-F muestra una notable variabilidad según el escenario:
...
Por su parte, el algoritmo \texttt{AM} presenta un rendimiento intermedio: mejora las métricas obtenidas por \texttt{RS} y \texttt{WC},
...
\begin{table}[htp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{P{2.2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2cm} P{2.5cm}}
            \toprule
            \textbf{Algoritmo} & \textbf{Duración Total} & \textbf{Duración/Eva.} & \textbf{Accuracy} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-score} & \textbf{Evaluaciones} & \textbf{Porc.
            Final}                                                                                                                                                                                       \\
            \midrule
            \multicolumn{9}{l}{\textbf{10\%}}                                                                                                                                                            \\
            \midrule
            AM                 & 00:27:39                & 00:00:17               & 83,66\%           & 84,24\%            & 83,66\%         & 83,09\%           & 100                   & 10,00\%       \\
            MEM                & 00:27:43                & 00:00:17               & 82,85\%           & 84,44\%            & 82,85\%         & 81,91\%           & 100                   & 10,00\%       \\
            MEM-F              & 00:32:39                & 00:00:20               & 83,28\%           & 84,70\%            & 83,28\%         & 82,46\%           & 100                   & 9,62\%        \\
            RS                 & 00:38:17                & 00:00:22               & 81,34\%           & 82,46\%            & 81,34\%         & 80,52\%           & 100                   & 10,00\%       \\
            WC                 & 00:34:03                & 00:00:21               & 83,60\%           & 84,38\%            & 83,60\%         & 82,82\%           & 100                   & 10,00\%       \\
            \midrule
            \multicolumn{9}{l}{\textbf{25\%}}                                                                                                                                                            \\
            \midrule
...
En primer lugar, el \texttt{MEM-F} se consolida como la solución más robusta y eficaz: no solo alcanza la mayor precisión en términos de \textit{accuracy},
...
El MEM-F obtiene el mejor rendimiento general, con una mediana que ronda el \textbf{0.927} y un valor máximo de \textbf{0.933},
...
\begin{table}[htp]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tabular}{P{2.5cm} P{2cm} P{2.5cm} P{2.5cm} P{2.5cm} P{2.5cm} P{2cm}}
            ...
            \midrule
            MEM                & 91,89\%                 & 91,63\%                  & 91,89\%               & 91,67\%                 & 100                   & 25,00\%       \\
            MEM-F              & 92,24\%                 & 92,06\%                  & 92,24\%               & 92,09\%                 & 100                   & 41,35\%       \\
            \midrule
            \multicolumn{7}{l}{\textbf{50\%}}                                                                                                                                 \\
            \midrule
            MEM                & 92,73\%                 & 92,61\%                  & 92,73\%               & 92,63\%                 & 100                   & 50,00\%       \\
            MEM-F              & 93,11\%                 & 93,00\%                  & 93,11\%               & 93,01\%                 & 100                   & 68,69\%       \\
            \midrule
