\chapter{Fundamentos de Aprendizaje Profundo}\label{ch:fundamentos_de_aprendizaje_profundo}
%Fundamentos de Aprendizaje Profundo: Explica los conceptos básicos, incluyendo redes neuronales convolucionales.
\section{Definición de Aprendizaje Profundo}\label{subsec:definicion_de_aprendizaje_profundo}
...
\section{Redes Neuronales Artificiales}\label{subsec:redes_neuronales_artificiales}
...
\section{Redes Neuronales Convolucionales}\label{subsec:redes_neuronales_convolucionales}
...
\subsubsection{Funcionamiento General de una CNN}\label{subsubsec:funcionamiento_general_de_una_cnn}
