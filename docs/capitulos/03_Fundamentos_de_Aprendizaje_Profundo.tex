...
El \textbf{aprendizaje profundo} (Deep Learning)~\cite{weidman_deep_2019} es una subcategoría del aprendizaje automático que se basa
...
\textbf{ResNet50}~\cite{noauthor_resnet50_nodate} es una arquitectura de red neuronal convolucional introducida por Kaiming He et al.\ en 2015.
