...
def genetic_algorithm_with_restart(
    ...
    def initialize_population(size: int, keep_best: bool = False) -> tuple[list, list, list]:
        """
    ...
    # Inicialización
    evaluations_done = 0
    population, fitness_dicts, fitness_values = initialize_population(population_size)
